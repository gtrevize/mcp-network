...
const TOOLS: Tool[] = [
  ...
  {
    name: 'get_ip_address',
    description: 'Detects the server\'s public IPv4 address using DNS queries (primary method, fast) with API service fallback. Returns the actual IP address detected.',
    inputSchema: {
      type: 'object',
      properties: {},
    },
